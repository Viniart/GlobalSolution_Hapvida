...
public class KafkaProducerConfig {
    ...
    @Bean
    public ProducerFactory<String, Consulta> producerFactory() {
        return new DefaultKafkaProducerFactory<>(producerConfig());
    }

    @Bean
    public KafkaTemplate<String, Consulta> kafkaTemplate(ProducerFactory<String, Consulta> producerFactory) {
