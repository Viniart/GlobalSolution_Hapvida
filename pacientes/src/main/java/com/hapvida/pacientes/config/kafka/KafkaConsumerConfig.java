...
public class KafkaConsumerConfig {
    ...
    @Bean
    public ConsumerFactory<String, Consulta> consumerFactory() {
        return new DefaultKafkaConsumerFactory<>(consumerConfig());
    }

    public KafkaListenerContainerFactory<ConcurrentMessageListenerContainer<String, Consulta>> factory(ConsumerFactory<String, Consulta> consumerFactory) {
        ConcurrentKafkaListenerContainerFactory<String, Consulta> factory =
